...
class TestPublicIndex(unittest.TestCase):
    ...
    def test_keyboard_and_modal_buttons_have_extra_vertical_space(self) -> None:
        ...
        self.assertIn("--delete-key-height-adjust: 1px;", html)
        ...
        self.assertIn("min-height: calc(var(--key-font) + (var(--key-pad-y) * 2) + 4px + var(--delete-key-height-adjust));", html)
    ...
    def test_mobile_board_size_is_limited_by_available_viewport_height(self) -> None:
        ...
        self.assertIn("--mobile-topbar-height: 44px;", html)
        self.assertIn("--mobile-keyboard-row-height: calc(var(--key-font) + (var(--key-pad-y) * 2) + 4px + var(--key-height-adjust));", html)
        self.assertIn("--mobile-keyboard-action-height: calc(var(--key-font) + (var(--key-pad-y) * 2) + 4px + var(--delete-key-height-adjust));", html)
        self.assertIn("--mobile-keyboard-height: calc((var(--mobile-keyboard-row-height) * 3) + var(--mobile-keyboard-action-height) + (var(--key-gap) * 3));", html)
